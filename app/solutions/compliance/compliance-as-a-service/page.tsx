      ...
      <section className="section-dark section-padded">
        <div className="container" style={{ maxWidth: "760px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p className="body">
              <strong style={{ color: "var(--white)" }}>Internal teams</strong>
              {" "}often lack regulatory depth or consistency across jurisdictions.
            </p>
            <p className="body">
              <strong style={{ color: "var(--white)" }}>One-off consultants</strong>
              {" "}deliver documents, not operations.
            </p>
            <p className="body">
              <strong style={{ color: "var(--blue-light)" }}>Octus</strong>
