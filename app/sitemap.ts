...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${base}/what-we-do`, priority: 0.6, changeFrequency: "monthly" as const },
    { url: `${base}/regulatory`, priority: 0.7, changeFrequency: "monthly" as const },
    { url: `${base}/compliance`, priority: 0.7, changeFrequency: "monthly" as const },
    { url: `${base}/legal-architecture`, priority: 0.7, changeFrequency: "monthly" as const },
    { url: `${base}/corporate`, priority: 0.7, changeFrequency: "monthly" as const },
    { url: `${base}/private-clients`, priority: 0.6, changeFrequency: "monthly" as const },
    { url: `${base}/audit`, priority: 0.7, changeFrequency: "monthly" as const },
    { url: `${base}/international-hub`, priority: 0.6, changeFrequency: "monthly" as const },
