...
## Slide 1 — Who Octus is

**Headline:** Octus  
**Body:** An international advisory and coordination firm for regulated and high-scrutiny operations.  
**Supporting:** One commercial relationship. Specialist work coordinated under Octus.
...
- Local counsel and specialists when required  
- Client faces Octus  
- Gov fees and third-party costs described separately  

## Slide 10 — Team and specialist network

- Core commercial and specialist roles (use only approved names/titles from trust pack)  
- Network of counsel and specialists by matter  
- No invented bios or credentials  

**Pending human:** final name list for deck freeze.

## Slide 11 — Selected situations

**Only with approved evidence.**  
Placeholder until Rubio approves situations list:

- Licensing pathway under time pressure  
- Licensed operator without banking  
- Compliance rebuild before audit  

No logos, metrics, or named clients until approved.

## Slide 12 — Contact

- Commercial intake (Milla)  
- Website contact route  
- Jurisdictions / markets pointers as secondary  

## Optional appendices (separate modules)
